...
public class ItemWithCommentsAndBookingsDtoTest {
    ...
    final BookingForDataDto lastBooking = new BookingForDataDto(
            2L, booker.getId(),
            LocalDateTime.of(2023, 10, 11, 12, 13, 14),
            LocalDateTime.of(2023, 11, 12, 13, 14, 15));
    final BookingForDataDto nextBooking = new BookingForDataDto(
            3L, booker.getId(),
            LocalDateTime.of(2023, 10, 11, 12, 13, 14),
            LocalDateTime.of(2023, 11, 12, 13, 14, 15));
    final ItemWithCommentsAndBookingsDto itemWithDto = new ItemWithCommentsAndBookingsDto(
